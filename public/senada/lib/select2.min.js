(n => {
    ...
    (u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs || (u ? e = u : u = {}, g = {}, m = {}, y = {}, v = {}, n = Object.prototype.hasOwnProperty, s = [].slice, _ = /\.js$/, h = function(e, t) {
        var n, s, o = c(e),
            i = o[0],
            t = t[1];
        return e = o[1], i && (n = x(i = l(i, t))), i ? e = n && n.normalize ? n.normalize(e, (s = t, function(e) {
            return l(e, s)
        })) : l(e, t) : (i = (o = c(e = l(e, t)))[0], e = o[1], i && (n = x(i))), {
            f: i ? i + "!" + e : e,
            n: e,
            pr: i,
            p: n
        ...
        if ("undefined" == u || "function" == u) {
            for (t = !t.length && n.length ? ["require", "exports", "module"] : t, a = 0; a < t.length; a += 1)
                if ("require" === (i = (r = h(t[a], d)).f)) c[a] = f.require(e);
                else if ("exports" === i) c[a] = f.exports(e), l = !0;
            else if ("module" === i) o = c[a] = f.module(e);
            else if (w(g, i) || w(m, i) || w(v, i)) c[a] = x(i);
            else {
                if (!r.p) throw new Error(e + " missing " + i);
                r.p.load(r.n, b(s, !0), (t => function(e) {
                    g[t] = e
                })(i), {}), c[a] = g[i]
            }
            u = n ? n.apply(g[e], c) : void 0, e && (o && o.exports !== p && o.exports !== g[e] ? g[e] = o.exports : u === p && l || (g[e] = u))
        } else e && (g[e] = n)
    }, o = e = r = function(e, t, n, s, o) {
        if ("string" == typeof e) return f[e] ? f[e](t) : x(h(e, A(t)).f);
        if (!e.splice) {
            if ((y = e).deps && r(y.deps, y.callback), !t) return;
            t.splice ? (e = t, t = n, n = null) : e = p
        }
        return t = t || function() {}, "function" == typeof n && (n = s, s = o), s ? i(p, e, t, n) : setTimeout(function() {
            i(p, e, t, n)
        }, 4), r
    }, r.config = function(e) {
        return r(e)
    ...
    }), u.define("select2/utils", ["jquery"], function(i) {
        var s = {};
        ...
        s.Extend = function(e, t) {
            ...
            function i() {
                ...
                0 < t && (e.call(arguments, s.prototype.constructor), n = o.prototype.constructor), n.apply(this, arguments)
            }
            o.displayName = s.displayName, i.prototype = new function() {
                this.constructor = i
            };
            for (var n = 0; n < t.length; n++) {
                var r = t[n];
                i.prototype[r] = s.prototype[r]
            }
            for (var a = 0; a < e.length; a++) {
                var l = e[a];
                i.prototype[l] = (e => {
                    var t = function() {},
                        n = (e in i.prototype && (t = i.prototype[e]), o.prototype[e]);
                    return function() {
        ...
        e.prototype.on = function(e, t) {
            ...
            for (var t in e) {
                ...
                if (1 !== n.length) {
                    for (var o = 0; o < n.length; o++) {
                        var i = n[o];
                        (i = i.substring(0, 1).toLowerCase() + i.substring(1)) in s || (s[i] = {}), o == n.length - 1 && (s[i] = e[t]), s = s[i]
                    }
                    delete e[t]
                }
            }
            ...
            var n = i(t),
                s = t.style.overflowX,
                o = t.style.overflowY;
            return (s !== o || "hidden" !== o && "visible" !== o) && ("scroll" === s || "scroll" === o || n.innerHeight() < t.scrollHeight || n.innerWidth() < t.scrollWidth)
        ...
        return s.GetUniqueElementId = function(e) {
            ...
            return t ? s.__cache[n] && null != s.__cache[n][t] ? s.__cache[n][t] : i(e).data(t) : s.__cache[n]
        ...
        return d.Extend(s, d.Observable), s.prototype.render = function() {
            ...
            for (t in (null != e.element && o.call(e.element, ":disabled") || null == e.element && e.disabled) && (s["aria-disabled"] = "true", n.classList.remove("select2-results__option--selectable"), n.classList.add("select2-results__option--disabled")), null == e.id && n.classList.remove("select2-results__option--selectable"), null != e._resultId && (n.id = e._resultId), e.title && (n.title = e.title), e.children && (s.role = "group", s["aria-label"] = e.text, n.classList.remove("select2-results__option--selectable"), n.classList.add("select2-results__option--group")), s) n.setAttribute(t, s[t]);
            if (e.children) {
                for (var o = u(n), i = document.createElement("strong"), r = (i.className = "select2-results__group", this.template(e, i), []), a = 0; a < e.children.length; a++) {
                    var l = e.children[a],
                        l = this.option(l);
                    r.push(l)
                }
                ...
                c.append(r), o.append(i), o.append(c)
            ...
            this.$results.attr("id", n), t.on("results:all", function(e) {
                ...
                0 !== t.length && (e = d.GetData(t[0], "data"), t.hasClass("select2-results__option--selected") ? o.trigger("close", {}) : o.trigger("select", {
                    data: e
                }))
                ...
                var e, t = o.getHighlightedResults(),
                    ...
                    s = n.index(t);
                s <= 0 || (s = s - 1, 0 === t.length && (s = 0), (t = n.eq(s)).trigger("mouseenter"), n = o.$results.offset().top, t = t.offset().top, e = o.$results.scrollTop() + (t - n), 0 === s ? o.$results.scrollTop(0) : t - n < 0 && o.$results.scrollTop(e))
            }), t.on("results:next", function() {
                var e, t, n = o.getHighlightedResults(),
                    s = o.$results.find(".select2-results__option--selectable"),
                    n = s.index(n) + 1;
                n >= s.length || ((s = s.eq(n)).trigger("mouseenter"), e = o.$results.offset().top + o.$results.outerHeight(!1), s = s.offset().top + s.outerHeight(!1), t = o.$results.scrollTop() + s - e, 0 === n ? o.$results.scrollTop(0) : e < s && o.$results.scrollTop(t))
            ...
            var e, t, n, s, o = this.getHighlightedResults();
            0 !== o.length && (e = this.$results.find(".select2-results__option--selectable").index(o), t = this.$results.offset().top, s = o.offset().top, n = this.$results.scrollTop() + (s - t), s = s - t, n -= 2 * o.outerHeight(!1), e <= 2 ? this.$results.scrollTop(0) : (s > this.$results.outerHeight() || s < 0) && this.$results.scrollTop(n))
    ...
    }), u.define("select2/selection/base", ["jquery", "../utils", "../keys"], function(n, s, o) {
        function i(e, t) {
            this.$element = e, this.options = t, i.__super__.constructor.call(this)
        }
        return s.Extend(i, s.Observable), i.prototype.render = function() {
        ...
        return n.Extend(o, t), o.prototype.render = function() {
            ...
            var n = this,
                s = (o.__super__.bind.apply(this, arguments), t.id + "-container");
    ...
    }), u.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function(s, e, c) {
        function o(e, t) {
            o.__super__.constructor.apply(this, arguments)
        }
        return c.Extend(o, e), o.prototype.render = function() {
            ...
            var n = this,
                e = (o.__super__.bind.apply(this, arguments), e.id + "-container");
            ...
            if (this.clear(), 0 !== e.length) {
                for (var t = [], n = this.$selection.find(".select2-selection__rendered").attr("id") + "-choice-", s = 0; s < e.length; s++) {
                    var o = e[s],
                        ...
                        r = (o.id ? a += o.id : a += c.generateChars(4), i.find(".select2-selection__choice__display").append(r).attr("id", a), o.title || o.text),
                        r = (r && i.attr("title", r), this.options.get("translations").get("removeItem")),
                        l = i.find(".select2-selection__choice__remove");
                    l.attr("title", r()), l.attr("aria-label", r()), l.attr("aria-describedby", a), c.StoreData(i[0], "data", o), t.push(i)
                }
    ...
    }), u.define("select2/selection/allowClear", ["jquery", "../keys", "../utils"], function(o, s, a) {
        function e() {}
            ...
            if (!this.isDisabled()) {
                ...
                if (0 !== n.length) {
                    ...
                    var s = a.GetData(n[0], "data"),
                        o = this.$element.val(),
                        i = (this.$element.val(this.placeholder.id), {
                            data: s
                        });
                    if (this.trigger("clear", i), i.prevented) this.$element.val(o);
                    else {
                        for (var r = 0; r < s.length; r++)
                            if (i = {
                                    data: s[r]
                                }, this.trigger("unselect", i), i.prevented) return void this.$element.val(o);
        ...
        return e.prototype.render = function(e) {
            ...
            var s = this,
                o = t.id + "-results",
                i = t.id + "-container",
                e = (e.call(this, t, n), s.$search.attr("aria-describedby", i), t.on("open", function() {
        ...
        return e.prototype.bind = function(e, t, n) {
            ...
            e.call(this, t, n), t.on("*", function(e, t) {
                var n; - 1 !== o.indexOf(e) && (n = r.Event("select2:" + e, {
                    params: t = t || {}
                }), s.$element.trigger(n), -1 !== i.indexOf(e)) && (t.prevented = n.isDefaultPrevented())
            })
        }, e
        ...
        return a.Extend(n, e), n.prototype.current = function(e) {
            ...
            o.selected = !0, null != o.element && "option" === o.element.tagName.toLowerCase() ? (o.element.selected = !0, this.$element.trigger("input").trigger("change")) : this.$element.prop("multiple") ? this.current(function(e) {
                ...
                for (var n = 0; n < o.length; n++) {
                    var s = o[n].id; - 1 === t.indexOf(s) && t.push(s)
                }
                i.$element.val(t), i.$element.trigger("input").trigger("change")
            ...
            if (null == (t = a.GetData(e[0], "data"))) {
                ...
                if ("option" === n.tagName.toLowerCase()) t = {
                    ...
                    for (var t = {
                            ...
                            children: [],
                            title: e.prop("title")
                        }, s = e.children("option"), o = [], i = 0; i < s.length; i++) {
                        var r = l(s[i]),
                            r = this.item(r);
                        o.push(r)
                    }
        ...
        return t.Extend(s, e), s.prototype.bind = function(e, t) {
            ...
            for (var i = 0; i < e.length; i++) {
                var r, a, l = this._normalizeItem(e[i]);
                0 <= s.indexOf(l.id) ? (r = n.filter((e => function() {
                    return c(this).val() == e.id
                })(l)), a = this.item(r), a = c.extend(!0, {}, l, a), a = this.option(a), r.replaceWith(a)) : (r = this.option(l), l.children && (a = this.convertToOptions(l.children), r.append(a)), o.push(r))
            }
            return o
        }, s
    }), u.define("select2/data/ajax", ["./array", "../utils", "jquery"], function(e, t, i) {
        function n(e, t) {
        ...
        return t.Extend(n, e), n.prototype._applyDefaults = function(e) {
            ...
            var s = this,
                o = (null != this._request && (i.isFunction(this._request.abort) && this._request.abort(), this._request = null), i.extend({
                    type: "GET"
                }, this.ajaxOptions));
        ...
        function e(e, t, n) {
            var s = n.get("tags"),
                o = n.get("createTag"),
                o = (void 0 !== o && (this.createTag = o), n.get("insertTag"));
            if (void 0 !== o && (this.insertTag = o), e.call(this, t, n), Array.isArray(s))
        ...
        return e.prototype.query = function(e, c, u) {
            ...
            this._removeOldTags(), null == c.term || null != c.page ? e.call(this, c, u) : e.call(this, c, function e(t, n) {
                for (var s = t.results, o = 0; o < s.length; o++) {
                    ...
                    if ((i.text || "").toUpperCase() === (c.term || "").toUpperCase() || r) return !n && (t.data = s, void u(t))
                }
                if (n) return !0;
                var a, l = d.createTag(c);
                null != l && ((a = d.option(l)).attr("data-select2-tag", !0), d.addOptions([a]), d.insertTag(s, l)), t.results = s, u(t)
            })
        ...
        return e.prototype.bind = function(e, t, n) {
            ...
            for (var o = n.get("tokenSeparators") || [], i = t.term, r = 0, a = this.createTag || function(e) {
                    return {
                        id: e.term,
                        text: e.term
                    }
                }; r < i.length;) {
                var l = i[r]; - 1 === o.indexOf(l) ? r++ : (l = i.substr(0, r), null == (l = a(c.extend({}, t, {
                    term: l
                }))) ? r++ : (s(l), i = i.substr(r + 1) || "", r = 0))
            }
            return {
                term: i
            }
    ...
    }), u.define("select2/dropdown/search", ["jquery"], function(i) {
        function e() {}
        return e.prototype.render = function(e) {
            var e = e.call(this),
                t = i('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></span>');
        ...
        return e.prototype.append = function(e, t) {
            ...
            for (var n = t.slice(0), s = t.length - 1; 0 <= s; s--) {
                var o = t[s];
                this.placeholder.id === o.id && n.splice(s, 1)
            }
            return n
        }, e
        ...
        return e.prototype.bind = function(e, t, n) {
            ...
            var n = this,
                ...
                i = this.$container.parents().filter(r.hasScroll);
            i.each(function() {
            ...
            var e = u(window),
                ...
                i = (o.bottom = o.top + this.$container.outerHeight(!1), {
            ...
            (u.contains(document.body, l[0]) || l[0].isConnected) && (c = l.offset()), o.top -= c.top, o.left -= c.left, t || n || (s = "below"), e || !a || t ? !a && e && t && (s = "below") : s = "above", ("above" == s || t && "below" !== s) && (o.top = i.top - c.top - r), null != s && (this.$dropdown[0].classList.remove("select2-dropdown--below"), this.$dropdown[0].classList.remove("select2-dropdown--above"), this.$dropdown[0].classList.add("select2-dropdown--" + s), this.$container[0].classList.remove("select2-container--below"), this.$container[0].classList.remove("select2-container--above"), this.$container[0].classList.add("select2-container--" + s)), this.$dropdownContainer.css(o)
    ...
    }), u.define("select2/defaults", ["jquery", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/selectionCss", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./dropdown/dropdownCss", "./i18n/en"], function(l, i, r, a, c, u, d, p, h, f, g, t, m, y, v, _, w, b, $, x, A, D, S, O, E, L, C, T, q, e) {
        function n() {
            this.reset()
        }
        return n.prototype.apply = function(e) {
            ...
            for (var t, n = [], s = 0; s < e.language.length; s++) {
                var o = e.language[s]; - 1 === n.indexOf(o) && n.push(o)
            }
            ...
            this.defaults = {
                ...
                matcher: function e(t, n) {
                    ...
                    if (n.children && 0 < n.children.length) {
                        for (var s = l.extend(!0, {}, n), o = n.children.length - 1; 0 <= o; o--) null == e(t, n.children[o]) && s.children.splice(o, 1);
                        return 0 < s.children.length ? s : e(t, s)
                    }
                    var i = a(n.text).toUpperCase(),
                        r = a(t.term).toUpperCase();
                    return -1 < i.indexOf(r) ? n : null
                },
            ...
            var n = e.language,
                ...
                o = Array.prototype.concat.call(this._resolveLanguage(o), this._resolveLanguage(n), this._resolveLanguage(s), this._resolveLanguage(t));
            return e.language = o, e
        }, n.prototype._resolveLanguage = function(e) {
            if (!e) return [];
            if (l.isEmptyObject(e)) return [];
            if (l.isPlainObject(e)) return [e];
            for (var t, n = Array.isArray(e) ? e : [e], s = [], o = 0; o < n.length; o++) s.push(n[o]), "string" == typeof n[o] && 0 < n[o].indexOf("-") && (t = n[o].split("-")[0], s.push(t));
            return s
            ...
            for (var n = new g, s = 0; s < e.length; s++) {
                ...
                if ("string" == typeof i) try {
                    ...
                    try {
                        i = this.defaults.amdLanguageBase + i, o = g.loadPath(i)
                    } catch (e) {
                        t && window.console && console.warn && console.warn('Select2: The language file for "' + i + '" could not be automatically loaded. A fallback will be used instead.')
                    }
                } else o = l.isPlainObject(i) ? new g(i) : i;
                n.extend(o)
            }
            return n
        ...
        return e.prototype.fromElement = function(e) {
            ...
            for (var o = 0; o < e[0].attributes.length; o++) {
                var i = e[0].attributes[o].name,
                    r = "data-";
                i.substr(0, r.length) == r && (i = i.substring(r.length), r = u.GetData(e[0], i), n[i.replace(/-([a-z])/g, s)] = r)
            }
    ...
    }), u.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(t, o, i, s) {
        function r(e, t) {
            null != i.GetData(e[0], "select2") && i.GetData(e[0], "select2").destroy(), this.$element = e, this.id = this._generateId(e), this.options = new o(t = t || {}, e), r.__super__.constructor.call(this);
            var t = e.attr("tabindex") || 0,
                t = (i.StoreData(e[0], "old-tabindex", t), e.attr("tabindex", "-1"), this.options.get("dataAdapter")),
        ...
        return i.Extend(r, i.Observable), r.prototype._generateId = function(e) {
            ...
            var s = e.attr("style");
            if ("string" == typeof s)
                for (var o = s.split(";"), i = 0, r = o.length; i < r; i += 1) {
            ...
            this.on("open", function() {
                ...
                var t = e.which;
                n.isOpen() ? t === s.ESC || t === s.TAB || t === s.UP && e.altKey ? (n.close(e), e.preventDefault()) : t === s.ENTER ? (n.trigger("results:select", {}), e.preventDefault()) : t === s.SPACE && e.ctrlKey ? (n.trigger("results:toggle", {}), e.preventDefault()) : t === s.UP ? (n.trigger("results:previous", {}), e.preventDefault()) : t === s.DOWN && (n.trigger("results:next", {}), e.preventDefault()) : (t === s.ENTER || t === s.SPACE || t === s.DOWN && e.altKey) && (n.open(), e.preventDefault())
            })
            ...
            if (void 0 === t && (t = {}), e in s) {
                ...
                if (n.call(this, s[e], o), o.prevented) return void(t.prevented = !0)
            }
            n.call(this, e, t)
        ...
        function s(e) {
            var t, n = e || window.event,
                ...
                a = 0,
                l = 0;
            if ((e = c.event.fix(n)).type = "mousewheel", "detail" in n && (r = -1 * n.detail), "wheelDelta" in n && (r = n.wheelDelta), "wheelDeltaY" in n && (r = n.wheelDeltaY), "wheelDeltaX" in n && (i = -1 * n.wheelDeltaX), "axis" in n && n.axis === n.HORIZONTAL_AXIS && (i = -1 * r, r = 0), o = 0 === r ? i : r, "deltaY" in n && (o = r = -1 * n.deltaY), "deltaX" in n && (i = n.deltaX, 0 === r) && (o = -1 * i), 0 !== r || 0 !== i) return 1 === n.deltaMode ? (o *= t = c.data(this, "mousewheel-line-height"), r *= t, i *= t) : 2 === n.deltaMode && (o *= t = c.data(this, "mousewheel-page-height"), r *= t, i *= t), t = Math.max(Math.abs(r), Math.abs(i)), (!d || t < d) && g(n, d = t) && (d /= 40), g(n, t) && (o /= 40, i /= 40, r /= 40), o = Math[1 <= o ? "floor" : "ceil"](o / d), i = Math[1 <= i ? "floor" : "ceil"](i / d), r = Math[1 <= r ? "floor" : "ceil"](r / d), h.settings.normalizeOffset && this.getBoundingClientRect && (n = this.getBoundingClientRect(), a = e.clientX - n.left, l = e.clientY - n.top), e.deltaX = i, e.deltaY = r, e.deltaFactor = d, e.offsetX = a, e.offsetY = l, e.deltaMode = 0, s.unshift(e, o, i, r), u && clearTimeout(u), u = setTimeout(f, 200), (c.event.dispatch || c.event.handle).apply(this, s)
        }
    ...
    }, "function" == typeof u.define && u.define.amd ? u.define("jquery-mousewheel", ["jquery"], o) : "object" == typeof exports ? module.exports = o : o(t), u.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function(o, e, i, t, r) {
        var a;
        ...
        }), null == o.fn.select2.defaults && (o.fn.select2.defaults = t), i
    });
    var e, p, i, r, h, f, g, m, y, v, n, s, _, o, a = {
        define: u.define,
        require: u.require
    };
    ...
    function l(e, t) {
        var n, s, o, i, r, a, l, c, u, d, p = t && t.split("/"),
            h = y.map,
            f = h && h["*"] || {};
        if (e) {
            ...
            for (c = (n = e.split("/")).length; 0 < c; --c) {
                if (s = n.slice(0, c).join("/"), p)
                    for (u = p.length; 0 < u; --u)
                        if (o = (o = h[p.slice(0, u).join("/")]) && o[s]) {
                            i = o, r = c;
                            break
                        }
                if (i) break;
                !a && f && f[s] && (a = f[s], l = c)
            }!i && a && (i = a, r = l), i && (n.splice(0, r, i), e = n.join("/"))
        }
        return e
    }
    ...
    function x(e) {
        var t;
        if (w(m, e) && (t = m[e], delete m[e], v[e] = !0, i.apply(p, t)), w(g, e) || w(v, e)) return g[e];
