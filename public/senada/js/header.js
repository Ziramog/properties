...
try {
    ...
    var dropdownSide = new TINY.dropdown.init("dropdownSide", {
        id: 'sideMenu',
        active: 'menuhover',
        fade: true,
        slide: true,
...
$(document).ready(function() {
    ...
    var sideMenu = $('.sideMenu .dropdown ul').html();
    $('.mobileMenu').append(mainMenu).append(sideMenu);
    ...
    $('.arrow').click(function(e) {
        ...
        if ($(this).siblings('ul').length) {
            $(this).siblings('ul').prepend('<li><a href="' + href + '">' + title + '</a></li>');
        }
    })
    $('.rButton').click(function(e) {
        e.preventDefault();
        var label = $(this).data('label');
        var labelAlt = $(this).data('label-alt');
        $(this).toggleClass('active');
        if ($(this).hasClass('active')) {
            $(this).attr('aria-label', labelAlt);
            $('.rOptions').slideDown();
            $('body').addClass('no-scroll');
            $('.mainHeader').addClass('menuOpened');
        } else {
            $('.mainHeader.menuOpened').removeClass('menuOpened');
