  ...
  return (
    <section className='relative h-[100dvh] min-h-[100dvh]'>
      ...
      <div className='relative z-10 h-full md:flex md:flex-col'>
        {/* Title Area */}
        <div className='absolute left-0 w-full px-6 text-center bottom-[350px] md:absolute md:top-[60%] md:left-0 md:w-full md:flex md:flex-col md:items-center'>
          <motion.div
      ...
      {showMore && (
        <div
          className='md:hidden fixed inset-0 bg-black/60 transition-opacity duration-300 z-[40]'
